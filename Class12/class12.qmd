...
ANS: We can observe that the expression level of ORMDL3 for A/A is higher than G/G. This result suggests that A allele could be related with higher level expression of ORMDL3 when compared to G allele.The expression levels of ORMDL3 for the A/G heterozygotes is in the midle of the A/A and G/G expression levels, suggesting that A/G could have a codominant effect.
